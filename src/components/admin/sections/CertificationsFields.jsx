...
export function CertificationsFields({ register, control }) {
  ...
  return (
    <div className="flex flex-col gap-3">
            ...
            <div className="card-body gap-2 p-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Issuer"
                  {...register(`content.items.${index}.issuer`)}
                />
                <input
                  className="input input-bordered input-sm flex-1"
                  placeholder="Date"
              ...
              <input
                ...
                {...register(`content.items.${index}.credentialUrl`)}
              />
              <input
                className="input input-bordered input-sm"
      ...
      <button
        ...
        onClick={() =>
          append({ title: "", issuer: "", date: "", credentialUrl: "", imageUrl: "" })
        }
      >
        + Add certification
      </button>
